...
A prospect requests **50 desks**. The company has **15 finished desks**. It manufactures **20 more** but lacks material for the remaining **15**, so Purchasing obtains the missing material. Production makes the final **15 desks**, bringing finished stock to **50** (15 opening + 20 first batch + 15 second batch). The warehouse delivers them, Finance invoices the customer, and the customer later reports **one damaged desk**. Only **35 new desks** are manufactured.
...
- customer invoice
- customer payment if subsequently received and matched
...
Payment is a possible continuation, not a stated completed event. The complaint can follow delivery independently of payment. The diagram uses these separate branches so support does not wait for settlement.
